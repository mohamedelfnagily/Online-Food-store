...
namespace NahlasKitchen.Migrations
{
    ...
    [Migration("20221009194712_updatingMobileNumber")]
    partial class updatingMobileNumber
    {
            ...
            modelBuilder.Entity("NahlasKitchen.Models.Cart", b =>
                {
                    b.HasOne("NahlasKitchen.Models.User", "user")
                        .WithOne("cart")
                        .HasForeignKey("NahlasKitchen.Models.Cart", "userId")
            ...
            modelBuilder.Entity("NahlasKitchen.Models.Product", b =>
                {
                    ...
                    b.HasOne("NahlasKitchen.Models.Category", null)
                        .WithMany("products")
